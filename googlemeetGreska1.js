class GoogleMeetGreska1 {
    ...
    static dajZadnjePredavanje(stranica) {
     ...
     //  var weeks = select.querySelectorAll('.weeks');
       ...
       //for petlja prolazi do velicine izabranih linkova, ali poredjenje vrsi nad stvarnim linkovima 
       for (var i = 0; i < links.length; i++) {
          if (htmlformat.getElementsByTagName("a")[i].toString().includes("meet.google.com") &&
                htmlformat.getElementsByTagName("a")[i].textContent.includes("predavanj"))
             niz.push(links[i]);
       }
    ...
    //for petlja prolazi do velicine izabranih linkova, ali poredjenje vrsi nad stvarnim linkovima 
       ...
       for (var i = 0; i < links.length; i++) {
          if (htmlformat.getElementsByTagName("a")[i].toString().includes("meet.google.com") &&
          htmlformat.getElementsByTagName("a")[i].textContent.includes("vjez") || 
          htmlformat.getElementsByTagName("a")[i].textContent.includes("vjež"))
             niz.push(links[i]);
       }
